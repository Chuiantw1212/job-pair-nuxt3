<template>
    <div>
        ...
        <div class="checkMultiple" :style="{ 'flex-direction': flexDirection }">
            ...
            <template v-for="(item, key) in items">
                <label v-if="item[itemText]" class="checkMultiple__label" :style="itemStyle">
                    ...
                    <input v-show="false" v-model="localValue" class="label__input" :value="item[itemValue]"
                        type="checkbox" :disabled="checkDisabled(item)" />
                    {{ item[itemText] }}
                </label>
            </template>
        </div>
