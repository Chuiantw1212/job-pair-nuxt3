    ...
    app: {
        head: {
            ...
            link: [
                ...
                // Bootstrap
                { rel: "preload", href: "https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css", as: "style", onload: "this.onload=null;this.rel='stylesheet'", integrity: "sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC", crossorigin: "anonymous", type: "text/css", media: "screen" },
                // Flatpickr
